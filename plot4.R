...
png(filename = "plot4.png",
    ...
    bg = "white",  res = NA)
##arrange 4 plots in 2 by 2 array
par(mfrow=c(2,2))
#first plot
plot(hpc$Global_active_power ,xaxt = "n",type="n",ylab="Global Active Power",xlab="")
lines(hpc$Global_active_power)
axis(1,at=c(1,1440,2880),labels=c("Thu","Fri","Sat"))
# second plot
plot(hpc$Voltage ,xaxt = "n",type="n",ylab="Energy sub metering",xlab="datetime")
lines(hpc$Voltage)
...
#fourth plot
plot(hpc$Global_reactive_power ,xaxt = "n",type="n",ylab="Global_reactive_power",xlab="datetime")
lines(hpc$Global_reactive_power)
axis(1,at=c(1,1440,2880),labels=c("Thu","Fri","Sat"))
